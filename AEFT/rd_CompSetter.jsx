...
(function rd_CompSetter(thisObj) {
  ...
  rd_CompSetterData.strDuration = {
    en: "Duration:",
  };
  rd_CompSetterData.strDurationAsFrames = {
    en: "frames",
  };
  rd_CompSetterData.strDurationAsSecs = {
    en: "seconds",
  };
  ...
  rd_CompSetterData.strWidth = {
    en: "Width:",
  };
  rd_CompSetterData.strHeight = {
    en: "Height:",
  };
  rd_CompSetterData.strSizeCaption = {
    en: "px",
  };
  rd_CompSetterData.strPAR = {
    en: "PAR:",
  };
  rd_CompSetterData.strRenderer = {
    en: "Renderer:",
  };
  rd_CompSetterData.strRendererEnums = ["ADBE Advanced 3d", "ADBE Picasso"];
  rd_CompSetterData.strRendererOptions = {
    en: '["Don\'t Change", "Classic 3D", "Ray-traced 3D"]',
  };
  rd_CompSetterData.strPreserveFrameRate = {
    en: "Preserve frame rate when nested or in render queue:",
  };
  rd_CompSetterData.strPreserveResolution = {
    en: "Preserve resolution when nested:",
  };
  rd_CompSetterData.strPreserveOptions = {
    en: '["Don\'t Change", "Preserve", "Don\'t Preserve"]',
  };
  rd_CompSetterData.strShutterAngle = {
    en: "Shutter Angle:",
  };
  rd_CompSetterData.strShutterPhase = {
    en: "Shutter Phase:",
  };
  rd_CompSetterData.strSamplesPerFrame = {
    en: "Samples Per Frame:",
  };
  rd_CompSetterData.strAdaptiveSampleLimit = {
    en: "Adaptive Sample Limit:",
  };
  rd_CompSetterData.strLayerSwitchesOpts = {
    en: "Layer Switches and Options (modify all layers)",
  };
  rd_CompSetterData.strLayerDim = {
    en: "Dimensionality:",
  };
  rd_CompSetterData.strLayerDimOptions = {
    en: '["Don\'t Change", "Switch to 3D, including Per-char 3D Text", "Switch to 3D", "Switch to 2D"]',
  };
  rd_CompSetterData.strRecursive = {
    en: "Update nested compositions",
  };
  rd_CompSetterData.strApply = {
    en: "Apply",
  };
  rd_CompSetterData.strHelp = {
    en: "?",
  };
  rd_CompSetterData.strErrNoProj = {
    en: "Cannot perform operation. Please create or open a project, open a single composition, and try again.",
  };
  rd_CompSetterData.strErrNoCompSel = {
    en: "Cannot perform operation. Please select or open a single composition in the Project window, and try again.",
  };
  rd_CompSetterData.strMinAE100 = {
    en: "This script requires Adobe After Effects CS5 or later.",
  };
  rd_CompSetterData.strHelpText = {
    en:
      "Copyright (c) 2006-2015 redefinery (Jeffrey R. Almasol). \n" +
      "All rights reserved.\n" +
      "\n" +
  ...
  function rd_CompSetter_buildUI(thisObj) {
    var pal =
      thisObj instanceof Panel
        ? thisObj
        : new Window("palette", rd_CompSetterData.scriptName, undefined, {
            resizeable: true,
          });
    var res;
    ...
    if (pal !== null) {
      ...
      res =
        ...
        "', alignment:['fill','center'] }, \
					help: Button { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strHelp) +
        "', maximumSize:[30,20], alignment:['right','center'] }, \
				}, \
				width: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strWidth) +
        "', value:false }, \
					fld: EditText { text:'1920', characters:7, preferredSize:[-1,20] }, \
					uom: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strSizeCaption) +
        "' }, \
				}, \
				height: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strHeight) +
        "', value:false }, \
        ...
        "' }, \
				...
				par: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strPAR) +
        "', value:false }, \
				...
				fps: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strFPS) +
        "', value:false }, \
					fld: EditText { text:'29.97', characters:7, preferredSize:[-1,20] }, \
					uom: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strFPSCaption) +
        "' }, \
				}, \
				dur: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strDuration) +
        "', value:false }, \
					fld: EditText { text:'300', characters:7, preferredSize:[-1,20] }, \
					durFrames: RadioButton { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strDurationAsFrames) +
        "', value:true }, \
					durSecs: RadioButton { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strDurationAsSecs) +
        "' }, \
				}, \
				sep: Group { \
				...
				renderer: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					lbl: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strRenderer) +
        "' }, \
					lst: DropDownList { properties:{items:" +
        rd_CompSetter_localize(rd_CompSetterData.strRendererOptions) +
        " }, alignment:['left','center'], preferredSize:[-1,20] }, \
				}, \
				preserveFR: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					lbl: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strPreserveFrameRate) +
        "' }, \
					lst: DropDownList { properties:{items:" +
        rd_CompSetter_localize(rd_CompSetterData.strPreserveOptions) +
        " }, alignment:['fill','center'], preferredSize:[-1,20] }, \
				}, \
				preserveRes: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strPreserveResolution) +
        "' }, \
					lst: DropDownList { properties:{items:" +
        rd_CompSetter_localize(rd_CompSetterData.strPreserveOptions) +
        " }, alignment:['fill','center'], preferredSize:[-1,20] }, \
				...
				sa: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strShutterAngle) +
        "', value:false }, \
				...
				sp: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strShutterPhase) +
        "', value:false }, \
				...
				spf: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strSamplesPerFrame) +
        "', value:false }, \
				...
				asl: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strAdaptiveSampleLimit) +
        "', value:false }, \
				...
				layerSwitchesOpts: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					txt: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strLayerSwitchesOpts) +
        "' }, \
				}, \
				layerDim: Group { \
					alignment:['fill','top'], alignChildren:['left','center'], \
					opt: StaticText { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strLayerDim) +
        "' }, \
					lst: DropDownList { properties:{items:" +
        rd_CompSetter_localize(rd_CompSetterData.strLayerDimOptions) +
        " }, alignment:['fill','center'], preferredSize:[-1,20] }, \
				}, \
				sep3: Group { \
					orientation:'row', alignment:['fill','top'], \
				...
				recursive: Checkbox { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strRecursive) +
        "', value:true, alignment:['fill','center'] }, \
				cmds: Group { \
					alignment:['right','top'], \
					applyBtn: Button { text:'" +
        rd_CompSetter_localize(rd_CompSetterData.strApply) +
        "', preferredSize:[-1,20] }, \
				}, \
			}";
      pal.grp = pal.add(res);
      ...
      pal.grp.sa.opt.preferredSize.width =
        ...
        pal.grp.spf.opt.preferredSize.width =
          pal.grp.asl.opt.preferredSize.width;

      pal.grp.renderer.lst.selection =
        pal.grp.preserveFR.lst.selection =
        pal.grp.preserveRes.lst.selection =
        pal.grp.layerDim.lst.selection =
          0;
      ...
      pal.grp.width.opt.onClick =
        pal.grp.height.opt.onClick =
        pal.grp.fps.opt.onClick =
          function () {
            var state = this.value;
            this.parent.fld.enabled = this.parent.uom.enabled = state;
            if (state) this.parent.fld.active = true;
          };
      pal.grp.par.opt.onClick =
        pal.grp.sa.opt.onClick =
        pal.grp.sp.opt.onClick =
        pal.grp.spf.opt.onClick =
        pal.grp.asl.opt.onClick =
          function () {
            var state = this.value;
      ...
      pal.grp.width.fld.onChange = pal.grp.height.fld.onChange = function () {
        ...
        if (isNaN(enteredValue) || enteredValue < 4) this.text = "4";
        else if (enteredValue > 30000) this.text = "30000";
        else this.text = enteredValue.toString();
      };

      pal.grp.par.fld.onChange = function () {
        var enteredValue = parseFloat(this.text);

        if (isNaN(enteredValue) || enteredValue < 0.01) this.text = "1";
        else if (enteredValue > 99) this.text = "99";
        else this.text = enteredValue.toString();
      };
      ...
      pal.grp.fps.fld.onChange = function () {
        ...
        if (isNaN(enteredValue) || enteredValue <= 1) this.text = "1";
        else if (enteredValue > 99) this.text = "99";
      };
      ...
      pal.grp.dur.fld.onChange = function () {
        ...
        if (isNaN(enteredValue) || enteredValue <= 0) this.text = "1";
      ...
      pal.grp.dur.durFrames.onClick = function () {
        ...
        this.parent.parent.fld.text = parseInt(
          this.parent.parent.fld.text
        ).toString();
      };
      ...
      pal.grp.sa.fld.onChange = function () {
        ...
        if (isNaN(enteredValue) || enteredValue < 0) this.text = "0";
        else if (enteredValue > 720) this.text = "720";
        else this.text = parseFloat(enteredValue).toString();
      };

      pal.grp.sp.fld.onChange = function () {
        var enteredValue = this.text;

        if (isNaN(enteredValue) || enteredValue < -360) this.text = "-360";
        else if (enteredValue > 360) this.text = "360";
        else this.text = parseFloat(enteredValue).toString();
      };
      ...
      pal.grp.spf.fld.onChange = function () {
        ...
        if (isNaN(enteredValue) || enteredValue < 2) this.text = "2";
        else if (enteredValue > 64) this.text = "64";
        else this.text = parseFloat(enteredValue).toString();
      };
      ...
      pal.grp.asl.fld.onChange = function () {
        ...
        if (isNaN(enteredValue) || enteredValue < 16) this.text = "16";
        else if (enteredValue > 256) this.text = "256";
        else this.text = parseFloat(enteredValue).toString();
      };
  ...
  function rd_CompSetter_compSetRecursively(
    comp,
    width,
    height,
    par,
    ...
    if (width !== -1) comp.width = width;
    if (height !== -1) comp.height = height;

    // Change the comp's par
    if (par !== -1) comp.pixelAspect = par;

    // Change the comp's frame rate
    if (fps !== -1) comp.frameRate = fps;

    // Change the comp's duration
    if (dur !== -1) comp.duration = dur;

    // Change the comp's renderer
    if (ren !== -1) comp.renderer = rd_CompSetterData.strRendererEnums[ren];

    // Change the comp's preserve options
    if (fr !== -1) comp.preserveNestedFrameRate = fr === 0;
    if (res !== -1) comp.preserveNestedResolution = res === 0;

    // Change the comp's motion blur
    if (sa !== -1) comp.shutterAngle = sa;
    if (sp !== -1) comp.shutterPhase = sp;
    if (spf !== -1) comp.motionBlurSamplesPerFrame = spf;
    if (asl !== -1) comp.motionBlurAdaptiveSampleLimit = asl;
    ...
    for (i = 1; i <= comp.numLayers; i++) {
      ...
      if (dur !== -1) {
        if (layer.stretch >= 0) {
          if (layer.outPoint >= oldCompDur) layer.outPoint = comp.duration;
        } else {
  ...
  function rd_CompSetter_doCompSetter() {
    ...
    for (i = 0; i < selComps.length; i++) {
      ...
      rd_CompSetter_compSetRecursively(
        ...
        newASL,
        newLayerDim,
        this.parent.parent.recursive.value
      );
    }
    ...
    if (rdcsePal !== null) {
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_widthOpt"))
        rdcsePal.grp.width.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_widthOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_heightOpt"))
        rdcsePal.grp.height.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_heightOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_parOpt"))
        rdcsePal.grp.par.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_parOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_fpsOpt"))
        rdcsePal.grp.fps.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_fpsOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_durOpt"))
        rdcsePal.grp.dur.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_durOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_durFrames"))
        rdcsePal.grp.dur.durFrames.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_durFrames") ===
          "false"
            ? false
            : true;
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_durSecs"))
        rdcsePal.grp.dur.durSecs.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_durSecs") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_renderer"))
        rdcsePal.grp.renderer.lst.selection = parseInt(
          app.settings.getSetting("redefinery", "rd_CompSetter_renderer"),
          10
        );
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_preserveFR"))
        rdcsePal.grp.preserveFR.lst.selection = parseInt(
          app.settings.getSetting("redefinery", "rd_CompSetter_preserveFR"),
          10
        );
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_preserveRes"))
        rdcsePal.grp.preserveRes.lst.selection = parseInt(
          app.settings.getSetting("redefinery", "rd_CompSetter_preserveRes"),
          10
        );
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_saOpt"))
        rdcsePal.grp.sa.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_saOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_spOpt"))
        rdcsePal.grp.sp.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_spOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_spfOpt"))
        rdcsePal.grp.spf.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_spfOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_aslOpt"))
        rdcsePal.grp.asl.opt.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_aslOpt") ===
          "false"
            ? false
            : true;
      ...
      if (app.settings.haveSetting("redefinery", "rd_CompSetter_layerDim"))
        rdcsePal.grp.layerDim.lst.selection = parseInt(
          app.settings.getSetting("redefinery", "rd_CompSetter_layerDim"),
          10
        );

      if (app.settings.haveSetting("redefinery", "rd_CompSetter_recursive"))
        rdcsePal.grp.recursive.value =
          app.settings.getSetting("redefinery", "rd_CompSetter_recursive") ===
          "false"
            ? false
            : true;
      ...
      if (rdcsePal instanceof Window) {
        ...
        rdcsePal.center();
        rdcsePal.show();
      } else rdcsePal.layout.layout(true);
    }
  }
})(this);
