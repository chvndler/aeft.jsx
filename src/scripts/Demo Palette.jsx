{
  ...
  function DemoPalette(thisObj) {
    ...
    if (isSecurityPrefSet() == true) {
      ...
      var button1 = addScriptButton(
        my_palette,
        [l_button_left, 5, l_button_right, 25],
        'Find and Replace Text',
        demosDirectory,
        'Find and Replace Text.jsx',
      );
      var button3 = addScriptButton(
        my_palette,
        [l_button_left, 30, l_button_right, 50],
        'Scale Composition',
        demosDirectory,
        'Scale Composition.jsx',
      );
      var button4 = addScriptButton(
        my_palette,
        [l_button_left, 55, l_button_right, 75],
        'Scale Selected Layers',
        demosDirectory,
        'Scale Selected Layers.jsx',
      );

      var button6 = addScriptButton(
        my_palette,
        [r_button_left, 5, r_button_right, 25],
        'Sort Layers by In Point',
        demosDirectory,
        'Sort Layers by In Point.jsx',
      );
      var button8 = addScriptButton(
        my_palette,
        [r_button_left, 30, r_button_right, 50],
        'Render and Email',
        myDirectory,
      ...
      alert(
        'This demo requires the scripting security preference to be set.\nGo to the "Scripting & Expressions" panel of your application preferences, and make sure that "Allow Scripts to Write Files and Access Network" is checked.',
        'Demo Palette',
      );
    }
  }
