{
  // Filename → Resize_Composition.jsx
  // Menu Name → Resize Composition
  // @version 1.0.0
  //
  // @description
  // This script scales the active composition and all the layers within it.
  //
  // It prompts the user for a scale_factor, a new comp width,
  // or a new comp height. It scales the comp and all the layers
  // within it, including cameras.
  //
  //
  // @copyright 2023
  // @license MIT

  function ResizeComposition(thisObj) {
    var scriptName = 'Resize Composition';
